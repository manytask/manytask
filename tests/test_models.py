...
def test_user_unique_username(session):
    user1 = User(username="unique_user1", first_name="Ivan", last_name="Ivanov", rms_id=1)
    user2 = User(username="unique_user2", first_name="Oleg", last_name="Ivanov", rms_id=2)
    user3 = User(username="unique_user3", first_name="Ivan", last_name="Olegov", rms_id=3)
    user4 = User(username="unique_user4", first_name="Ivan", last_name="Olegov", rms_id=4)
    user5 = User(username="unique_user1", first_name="Ivan", last_name="Ivanov", rms_id=5)
...
def test_user_on_course(session):
    user = User(username="user1", first_name="Ivan", last_name="Ivanov", rms_id=1)
...
def test_user_on_course_unique_ids(session):
    user1 = User(username="user001", first_name="Ivan", last_name="Ivanov", rms_id=1)
    course1 = make_course("001")
    user2 = User(username="user002", first_name="Ivan", last_name="Olegov", rms_id=2)
...
def test_grade(session, fixed_current_time):
    user = User(username="user2", first_name="Ivan", last_name="Ivanov", rms_id=1)
...
def test_grade_unique_ids(session, fixed_current_time):
    ...
    user1 = User(username="user101", first_name="Ivan", last_name="Ivanov", rms_id=1)
    user2 = User(username="user102", first_name="Ivan", last_name="Olegov", rms_id=2)
...
def test_cascade_delete_course(session):
    ...
    user1 = User(username="cascade_user1", first_name="Ivan", last_name="Ivanov", rms_id=1)
    user2 = User(username="cascade_user2", first_name="Ivan", last_name="Olegov", rms_id=2)
...
def test_cascade_delete_task_group(session):
    ...
    user = User(username="cascade_user3", first_name="Ivan", last_name="Ivanov", rms_id=1)
...
def test_cascade_delete_user(session):
    user = User(username="cascade_user4", first_name="Ivan", last_name="Ivanov", rms_id=1)
...
def test_cascade_delete_user_on_course(session):
    user = User(username="cascade_user5", first_name="Ivan", last_name="Ivanov", rms_id=1)
