...
def test_create_app_production_with_something_else(mock_env, mock_gitlab, monkeypatch):
    monkeypatch.setenv("STORAGE", "something_else")
    with pytest.raises(Exception):
        create_app()


def test_create_app_production_with_gsheets(mock_env, mock_gitlab, monkeypatch):
    monkeypatch.setenv("STORAGE", "gsheets")
    with pytest.raises(Exception):
        create_app()
